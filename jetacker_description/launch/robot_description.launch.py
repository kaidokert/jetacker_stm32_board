...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(jetacker_description_package_path, 'rviz/view.rviz')
    ...
    rviz_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(jetacker_description_package_path, 'launch', 'rviz.launch.py')),
